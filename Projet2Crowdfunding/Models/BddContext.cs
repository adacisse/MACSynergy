...
namespace Projet2Crowdfunding.Models
{
    public class BddContext : DbContext
    {
        ...
        public void InitializedDB()
        {
            ...
            //        Name = "La clinique de l'abstinence dans le parcours de soin",
            //        Summary = "",
            ...
            //        Id = 2,
            //        Status = Status.published,
            //        Name = "VIE SAUVAGE Pour une coexistence harmonieuse avec la vie sauvage",
            //        Summary = "",

            //        Descritpion = "Notre programme mondial « Vie Sauvage » s’emploie à sauvegarder les espèces terrestres menacées les plus emblématiques" +
            //        " d’un point de vue écologique, culturel et économique, dont la protection requiert une action concertée au niveau international," +
            //        " et qui supposent une cohabitation harmonieuse avec les activités humaines. Notre objectif est d’améliorer leur état de conservation et celui" +
            //        " des écosystèmes qui les hébergent à travers une approche inclusive et en étroite collaboration avec les communautés humaines avec qui elles partagent" +
            //        " les territoires...La déforestation et la surexploitation des terres,l’utilisation non durable des ressources naturelles,l’introduction d’espèces invasives," +
            //        "le braconnage et le commerce illégal des espèces sauvages ainsi que les changements climatiques et la pollution exercent une pression sans précédent sur " +
            //        "la nature.Pour assurer un avenir sain et durable aux espèces sauvages et à leurs habitats naturels ainsi qu’aux générations futuresle WWF se consacre depuis" +
            //        " plus de 50 ans à la lutte contre ces grandes menaces qui pèsent sur notre planète." +
            //        "La biodiversité mondiale décline à une vitesse fulgurante.Entre 1970 et 2016, l'évolution de l'Indice Planète Vivante(IPV) qui mesure la biodiversité mondiale," +
            //        "montrait une réduction de 68 % de l'abondance des populations de vertébrés. Le WWF se mobilise pour la vie sauvage en choisissant de protéger les espèces" +
            //        " les plus emblématiques et les plus vulnérables comme les loups, les lynx ou les tigres.Nous nous concentrons sur celles qui jouent un rôle majeur au sein des écosystèmes naturels.En les protégeant," +
            //        "nous sauvegardons aussi les espèces avec lesquelles elles cohabitent et les paysages ou les milieux qui les accueillent." +
            //        "Nos actions pour la faune sauvage encouragent le développement durable des territoires et la préservation de notre patrimoine naturel.Nous luttons, entre autres," +
            //        "contre le braconnage et la destruction des habitats.Nous mettons en œuvre des solutions pour rendre possible la coexistence avec les activités humaines. ",
